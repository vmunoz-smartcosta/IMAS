...
public class EntidadTagsClasificados {
    ...
    public EntidadTagsClasificados() {
    }

    public EntidadTagsClasificados(String TagSysId, String TagID, String TagTypeSysId, String Name, String estado){
