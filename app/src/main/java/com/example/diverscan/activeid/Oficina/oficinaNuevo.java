...
public class oficinaNuevo {
    public  String _IdOficina;
    public String _NombreOficina;
    public String _IdPiso;

    public oficinaNuevo (String idoficina, String nombreoficina, String idPiso){
